      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="text-center">
          ...
          <p className="mt-8 text-lg font-medium text-gray-500 sm:text-xl">
            Discover the best places to visit, eat, and relax in Singapore. Plan
            personalized trips using our AI-powered itinerary generator and
            explore hidden gems across the Lion City.
          </p>
